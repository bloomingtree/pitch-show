<template>
    <div class="h-full flex flex-col justify-between" style="background-color: #f8f7f4;">
      <div class="group fixed right-5 -top-96 shadow-lg shadow-inner p-3 bg-white rounded-md h-96 transition-all duration-300 z-50
      hover:top-0">
        ...
        <div class="absolute -bottom-16 left-0 h-16 w-1/3 group-hover:scale-y-0 group-hover:-bottom-8 transition-all delay-200">
